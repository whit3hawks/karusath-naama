...
<div class="lg:mt-12 mt-4 md:mt-6 w-full">
  <div class="container mx-auto md:px-6 px-4 mb-6 flex justify-end">
    <div class="w-full">
      <p class="dv-bold rtl text-center lg:text-4xl text-3xl opacity-80 tracking-[.06em]" style="line-height: 60px;">{{$news->title}}</p>
      <div class="text-xl pt-4 flex items-center mt-2 dv-bold rtl pb-6 flex items-center justify-center">
        @isset($news->author)
  ...
  <div class="container mx-auto flex">
    <div class="md:px-6 px-4 w-full lg:flex flex-row-reverse">
      <div class="w-full">
        <div class="w-full">
          @if(isset($news->video))
        ...
        <div class="md:mt-6">
          <div class="md:w-5/6 w-full mx-auto flex justify-center">
              ...
              <div class="md:border-r w-full md:border-gray-100 md:pr-6 md:mr-6">
                ...
                <div class="pb-6">
                  <div class="text-right flex justify-end font-semibold text-lg">
                    <div class="flex text-md items-center justify-end border-b border-gray-100 w-full uppercase">
                ...
                @isset($news->body)
                <div>
                  @include('frontend.components.newsblocks',['body' => $news->body])
                </div>
                @endisset
...
<script>
  ...
  // $('.twitfram').load(function() {
  //   alert(this.contentWindow.document.body.offsetHeight + 'px');
  //   document.getElementById("twitfram").style.height = this.contentWindow.document.body.offsetHeight + 'px';
  // });
