      ...
      <div class="container justify-between rtl h-20 mx-auto px-6 flex items-center">
        ...
        <div class="flex items-center">
          <div class="flex ml-2 md:text-base text-sm">
            <a href="https://banglavoice.mv/" class="hover:underline mx-2 text-white font-semibold">বাংলা</a>
            <div class="font-semibold en-font text-white">|</div>
            <a href="https://maldivesvoice.mv/" class="hover:underline mx-2 en-font font-semibold text-white">English</a>
          </div>
          <div class="flex items-center">
