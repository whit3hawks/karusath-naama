    ...
    <div class="container mx-auto px-6">
      <div class="py-6 flex justify-center">
        <div class="grid grid-cols-3 gap-6">
          <div class="bg-white bg-opacity-20 rounded-full w-10 h-10 flex justify-center items-center">
            <a target="_blank" href="https://t.me/karusathnaamamedia" class="mr-1">
              <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="22px" height="22px">
          ...
          <div class="bg-white bg-opacity-20 rounded-full w-10 h-10 flex justify-center items-center">
            <a target="_blank" href="https://twitter.com/karusathnaamamedia">
              <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="22px" height="22px">
